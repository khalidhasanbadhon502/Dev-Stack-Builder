      ...
      <div className="container mx-auto flex flex-col items-center justify-between gap-12 px-6 lg:flex-row">
        ...
        <div className="max-w-xl text-left">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <button className="rounded-xl border border-gray-200 bg-white px-6 py-3 text-sm font-semibold text-slate-600 transition-all hover:bg-gray-50 hover:text-slate-900">
              Learn More
            </button>
          </div>
        </div>
